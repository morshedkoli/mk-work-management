...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Pending", route: "/work/pending" },
          { label: "In Progress", route: "/work/inprogress" },
          { label: "Completed", route: "/work/completed" },
        ],
      },
      {
        icon: (
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 xl:py-10">
          <Link href="/">
            <div className=" text-3xl font-bold uppercase dark:hidden ">
              <h1 className="text-4xl">Mk Work </h1>
              <h2>Management</h2>
            </div>
            <div className="hidden text-3xl font-bold uppercase dark:block ">
              <h1 className="text-4xl">Mk Work </h1>
              <h2>Management</h2>
            </div>
          </Link>
